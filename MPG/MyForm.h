...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(40, 353);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(200, 353);
			...
			this->ClientSize = System::Drawing::Size(549, 421);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		this->label5->Text = Convert::ToString(mpg) + " MPG ";
		if (mpg <= 15)
			this->label6->Text = "Your Car is Very Ineffecient";
		else if (mpg>15 && mpg<=20)
			this->label6->Text = "Your Car is Ineffecient";
		else if (mpg >20 && mpg <= 30)
			this->label6->Text = "Your Car is Effecient";
		else if (mpg > 30 && mpg < 40)
			this->label6->Text = "Your Car is Super Effecient";
		else if (mpg >= 40)
			this->label6->Text = "Your Car is Extremely Effecient";
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	this->label5->Text = nullptr;
	this->label6->Text = nullptr;
}
